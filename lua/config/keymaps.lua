...
-- On this mac, Karabiner rewrites Ctrl + Backspace to Option + Backspace (the
-- macOS-wide word-delete), so the terminal never sees <C-BS> -- it gets Alt +
-- Backspace and sends <ESC><DEL>, which nvim reads as <M-BS>.
map({ "i", "c" }, "<M-BS>", "<C-w>", { noremap = true, silent = true })
